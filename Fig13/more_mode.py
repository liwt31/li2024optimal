...
nmode_str = sys.argv[1] # 0500 1000 2000
...
dump_dir = "./MoreMode/"
job_name = f"ps1_binary_ita{ita_str}_omega{omega_c_str}_beta{beta_str}_temperature{temperature_str}_nmode{nmode_str}"  ####################
log.register_file_output(dump_dir+job_name+".log", mode="w")


nmodes = int(nmode_str)
Ms = 20
upper_limit = 30
...
root = BasisTree.binary_mctdh(basis_vib, contract_primitive=True, contract_label=labels, mctdh_label="n").root
